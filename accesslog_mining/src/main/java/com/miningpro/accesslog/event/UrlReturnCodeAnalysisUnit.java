 ...
 */
public class UrlReturnCodeAnalysisUnit extends AnalysisUnit {
    private String url, returnCode;

    public UrlReturnCodeAnalysisUnit(String url, String returnCode) {
        this.url = url;
    ...
    public boolean equals(Object o) {
        ...
        UrlReturnCodeAnalysisUnit that = (UrlReturnCodeAnalysisUnit) o;
